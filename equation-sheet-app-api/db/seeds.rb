...
sr = Field.create(name: "Special Relativity", description: "Special relativity is the generally accepted and experimentally confirmed physical theory regarding the relationship between space and time")
